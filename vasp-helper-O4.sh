...
$dft_instalacion/remplazo.sh $dft_instalacion/$ruta".makefile.O4" >makefile.include
...
cp bin/vasp_std ~/bin/vasp_std-$sufijo-O4

cp bin/vasp_gam ~/bin/vasp_gam-$sufijo-O4

cp bin/vasp_ncl ~/bin/vasp_ncl-$sufijo-O4
