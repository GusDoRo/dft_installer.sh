...
cp fftw-$dft_fftw_version.tar.gz ./build/
cd build

tar -xzvf fftw-$dft_fftw_version.tar.gz

cd fftw-$dft_fftw_version
...
./configure --prefix=$dft_instalacion/build/fftw-$dft_fftw_version/install #--enable-mpi
