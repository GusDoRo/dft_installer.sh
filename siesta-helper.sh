...
extension=$2
sufijo=$3
trans=$4 # T significa que si

#directorio y descompresión de siesta
cp $ruta$extension ./build/
cd build

tar -xzvf $ruta$extension
...
#configuración
../Src/obj_setup.sh
$dft_instalacion/remplazo.sh $dft_instalacion/arch.make >arch.make
cp -R . ../Obj-trans-O2

#compilación del SIESTA 02
make
if test $? -ne 0; then
	echo $'\n\n...\n\nHubo un error'
	exit 1
...
cp siesta $dft_instalacion/bin/siesta-$sufijo
...
#configuración
../Src/obj_setup.sh
$dft_instalacion/remplazo.sh $dft_instalacion/arch.make-O4 >arch.make
cp -R ./ ../Obj-trans-O4

#compilación del SIESTA 04
make
if test $? -ne 0; then
	echo $'\n\n...\n\nHubo un error'
	exit 1
...
#exportando O4
cp siesta $dft_instalacion/bin/siesta-$sufijo"-O4"
...
then
	...
	cp transiesta $dft_instalacion/bin/transiesta-$sufijo
	...
	cp transiesta $dft_instalacion/bin/transiesta-$sufijo"-O4"
fi
