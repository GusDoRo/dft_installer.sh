...
cp $dft_instalacion/$ruta$extension .
#rm -R $ruta
...
$dft_instalacion/remplazo.sh $dft_instalacion/$ruta".makefile.O2" >makefile.include
...
cp bin/vasp_std ~/bin/vasp_std-$sufijo

cp bin/vasp_gam ~/bin/vasp_gam-$sufijo

cp bin/vasp_ncl ~/bin/vasp_ncl-$sufijo
