...
./01_01-variables.sh
if [[ $? -ne 0 ]]; then
        echo $'Error en 01_01'; exit 1
fi
./01_02-preinstalls-superuser.sh
if [[ $? -ne 0 ]]; then
        echo $'Error en 01_02'; exit 1
fi
./02_01-mpich.sh
if [[ $? -ne 0 ]]; then
        echo $'Error en 02_01'; exit 1
fi
./02_02-mpich.sh
if [[ $? -ne 0 ]]; then
        echo $'Error en 02_02'; exit 1
fi
./03_01-scalapack.sh
if [[ $? -ne 0 ]]; then
        echo $'Error en 03_01'; exit 1
fi
./03_02-scalapack.sh
if [[ $? -ne 0 ]]; then
        echo $'Error en 03_02'; exit 1
fi
./04_01-siesta.sh
if [[ $? -ne 0 ]]; then
        echo $'Error en 04_01'; exit 1
fi
./04_02-siesta-utils.sh
if [[ $? -ne 0 ]]; then
        echo $'Error en 04_02'; exit 1
fi
./04_03-rt.sh
if [[ $? -ne 0 ]]; then
        echo $'Error en 04_03'; exit 1
fi
./05_01-vasp.sh
if [[ $? -ne 0 ]]; then
        echo $'Error en 05_01'; exit 1
fi
./05_02-vasp.sh
if [[ $? -ne 0 ]]; then
        echo $'Error en 05_02'; exit 1
fi
./05_03-vasp.sh
if [[ $? -ne 0 ]]; then
        echo $'Error en 05_03'; exit 1
fi
./05_04-vasp.sh
if [[ $? -ne 0 ]]; then
        echo $'Error en 05_04'; exit 1
fi
